...
export default async function DashboardComparePage({ searchParams }: { searchParams?: { q?: string; city?: string; sort?: string; platforms?: string; inStock?: string; maxWaitMins?: string } }) {
