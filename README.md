...
- Zustand + React Query
- Prisma + Supabase-ready auth/data clients
- Upstash Redis and Algolia integration seams
- Resend email template, Vitest, and Playwright

## Getting started

1. Install dependencies with `npm install`.
2. Copy `.env.example` to `.env.local` and fill in your service keys.
3. Run `npm run dev`.
